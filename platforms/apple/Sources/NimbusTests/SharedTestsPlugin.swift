...
class TestPlugin: Plugin {
    ...
    func bind<C>(to connection: C) where C: Connection { // swiftlint:disable:this function_body_length
        ...
        connection.bind(binaryIntResolingIntCallbackReturnsInt, as: "binaryIntResolingIntCallbackReturnsInt")
    }
    ...
    func binaryIntResolingIntCallbackReturnsInt(param0: Int, callback: (Int) -> Void) -> Int {
        callback(param0 - 1)
        return param0 - 2
    }
}
